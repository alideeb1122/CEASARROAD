...
export function PlaneIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17.8 19.2L16 11l3.5-3.5C21 6 21 4 19.5 2.5S18 1 16.5 2.5L13 6l-8.2-1.8a.5.5 0 0 0-.4.1L3 5.5a.3.3 0 0 0 0 .4l6.3 4.1-2.8 2.8-1.7-.5a.5.5 0 0 0-.5.1L3.5 13a.3.3 0 0 0 0 .4l2.7 1.7 1.7 2.7a.3.3 0 0 0 .4 0l.8-.8a.5.5 0 0 0 .1-.5l-.5-1.7 2.8-2.8 4.1 6.3a.3.3 0 0 0 .4 0l1.2-1.2a.5.5 0 0 0 .1-.4z" />
    </svg>
  );
}
...
export function getServiceIcon(icon: string, className?: string) {
  switch (icon) {
    ...
    case "passport": return <PassportIcon className={className} />;
    case "hotel": return <HotelIcon className={className} />;
    case "shield": return <ShieldIcon className={className} />;
    case "check": return <CheckCircleIcon className={className} />;
    ...
    default: return <PlaneIcon className={className} />;
  }
}

export function getSocialIcon(type: string, className?: string) {
  switch (type) {
